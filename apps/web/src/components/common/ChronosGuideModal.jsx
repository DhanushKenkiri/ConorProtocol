...
/**
 * Chronos Guide Modal - sleek guide explaining how to use the Chronos Protocol
 */
const ChronosGuideModal = ({ show, onHide }) => {
  ...
  return (
    <Modal
      ...
      onHide={onHide}
      size="lg"
      aria-labelledby="chronos-guide-modal"
      centered
      className="chronos-guide-modal"
    >
      <Modal.Header closeButton>
        <Modal.Title id="chronos-guide-modal">
        ...
        {step === 1 && (
          <div className="guide-step">
            ...
            <ListGroup className="mb-3">
              <ListGroup.Item variant="dark">Create time-bound agreements with anyone</ListGroup.Item>
              <ListGroup.Item variant="dark">Set deadlines and financial incentives</ListGroup.Item>
              <ListGroup.Item variant="dark">Track agreement status and completion</ListGroup.Item>
              <ListGroup.Item variant="dark">All secured by blockchain technology</ListGroup.Item>
            </ListGroup>
            ...
            <Accordion defaultActiveKey="0" className="mb-4">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  </ol>                  <div className="text-center my-3">
                    <img src="/guides/connect-wallet.svg" alt="Connect Wallet Illustration" className="tutorial-image img-fluid border rounded" style={{ maxHeight: "200px" }} />
                  </div>
                </Accordion.Body>
              </Accordion.Item>
          ...
          <div className="guide-step">
            ...
            <Card className="mb-4 bg-dark border-secondary">
              <Card.Body>                <h5>Using the Command Format</h5>
                ...
                <div className="bg-dark text-light p-3 rounded mb-3 font-monospace border border-secondary">
            ...
            <div className="mb-4">
            ...
            </div>              <div className="alert alert-dark">
              ...
              <div className="card bg-dark border-secondary mb-3">
                ...
                <div className="card-body">
                  ...
                  <img src="/guides/chat-input.svg" alt="Chat Input Example" className="img-fluid border rounded" />
                </div>
              </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div className="guide-step">
            ...
            <ListGroup className="mb-4">
              <ListGroup.Item variant="dark"><strong>Pending</strong> - Created but not yet accepted</ListGroup.Item>
              <ListGroup.Item variant="dark"><strong>Active</strong> - Accepted and in progress</ListGroup.Item>
              <ListGroup.Item variant="dark"><strong>Completed</strong> - Marked as done and paid out</ListGroup.Item>
              <ListGroup.Item variant="dark"><strong>Expired</strong> - Deadline passed without completion</ListGroup.Item>
              <ListGroup.Item variant="dark"><strong>Cancelled</strong> - Cancelled by requester before acceptance</ListGroup.Item>
            </ListGroup>
        ...
        {step === 5 && (
          <div className="guide-step">
            ...
            <Accordion className="mb-4">              <Accordion.Item eventKey="0">
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>Agreement Not Appearing</Accordion.Header>
                <Accordion.Body>
                  <p>If your agreement doesn't appear after creation:</p>
                  <ul>
            ...
            <Card className="mb-3 bg-dark border-secondary">
              <ListGroup variant="flush">
                <ListGroup.Item action href="https://sepolia.basescan.org" target="_blank" className="bg-dark text-light">
                  Base Sepolia Block Explorer
                </ListGroup.Item>
                <ListGroup.Item action href="https://faucet.base.org" target="_blank" className="bg-dark text-light">
                  Base Sepolia Faucet
                </ListGroup.Item>
                <ListGroup.Item action href="https://docs.base.org" target="_blank" className="bg-dark text-light">
                  Base Documentation
                </ListGroup.Item>
              </ListGroup>
            </Card>
            ...
            <div className="alert alert-dark">
              ...
              <p className="mb-0">You now know the basics of using the Chronos Protocol. Click "Finish Guide" to start creating time-based agreements on the blockchain!</p>
            </div>
          </div>
        )}
      </Modal.Body>
      <Modal.Footer className="bg-dark border-secondary">
        <div className="d-flex w-100 justify-content-between">
          ...
          <div>
            {step < totalSteps ? (
              <Button variant="outline-light" onClick={nextStep}>
                Next
              </Button>
            ) : (
...
ChronosGuideModal.propTypes = {
  show: PropTypes.bool.isRequired,
  onHide: PropTypes.func.isRequired
};

export default ChronosGuideModal;
