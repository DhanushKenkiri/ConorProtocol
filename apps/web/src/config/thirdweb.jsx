...
// Helper function to format chain ID in proper hexadecimal with padding to ensure compatibility
export const formatChainIdHex = (chainId) => {
  // Convert number to hex, remove '0x' prefix, pad to 6 characters, add '0x' prefix back
...
// Export the properly formatted chain ID for MetaMask
export const BASE_SEPOLIA_CHAIN_ID_HEX = formatChainIdHex(BASE_SEPOLIA_CHAIN_ID);
...
export const BASE_SEPOLIA_PARAMS = {
  chainId: BASE_SEPOLIA_CHAIN_ID_HEX, // Using our formatted hex value
